...
private VermieterService vermieterService;
    ...
    public void testCreateSchuhe() throws Exception {
        ...
        createDTO.setSchuheType(SchuheType.FRAUENSCHUH);
...
void testCreateSchuhe1() {
    ...
    assertEquals(SchuheType.FRAUENSCHUH, schuhe.getSchuheType());
...
@Test
    ...
    public void testSetSchuheType() {
        Schuhe schuhe = new Schuhe();
        schuhe.setSchuheType(SchuheType.FRAUENSCHUH);
        assertEquals(SchuheType.FRAUENSCHUH, schuhe.getSchuheType());
    }
    ...
    sDTO.setPreis(150.0);
    sDTO.setSchuheType(SchuheType.FRAUENSCHUH);
    sDTO.setGroesse("40");
